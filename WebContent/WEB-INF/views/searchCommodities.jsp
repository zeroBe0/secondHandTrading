...
<body>
	...
	<a href="${pageContext.request.contextPath}/commodities?curPage=1">我的商品</a>
	<a href="${pageContext.request.contextPath}/orders?curPage=1">我的订单</a>
	<a href="${pageContext.request.contextPath}/newcommodity?curPage=1">发布商品</a>
	<br>
	<c:forEach items="${clist }" var="cc">
		<a href="${pageContext.request.contextPath}/home/${cc.key}?curPage=1">${cc.value}</a>
	</c:forEach>

	<form action="${pageContext.request.contextPath}/home/search?curPage=1"
		method="get">
